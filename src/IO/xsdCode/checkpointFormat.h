...
/**
 * @file
 * @brief Generated from checkpointFormat.xsd.
 */

#ifndef CXX_________INPUT_CHECKPOINT_FORMAT_H
#define CXX_________INPUT_CHECKPOINT_FORMAT_H
...
class particle_t: public ::xml_schema::type
{
   ...
   * @brief Element type.
   */
  typedef ::commonSchema::double_3d x_type;
   ...
   * @brief Element type.
   */
  typedef ::commonSchema::double_3d v_type;
   ...
   * @brief Element type.
   */
  typedef ::commonSchema::double_3d f_type;
   ...
   * @name old_f
   *
   * @brief Accessor and modifier functions for the %old_f
   * required element.
   */
  //@{
   ...
   * @brief Element type.
   */
  typedef ::commonSchema::double_3d old_f_type;
   ...
   * @brief Element type.
   */
  typedef ::commonSchema::nonNegativeDouble m_type;
   ...
   * @brief Element type.
   */
  typedef ::commonSchema::nonNegativeInteger type_type;
   ...
   */
  particle_t (::std::unique_ptr< x_type >,
...
Checkpoint (const ::Checkpoint_t& x, 
            const ::xml_schema::namespace_infomap& m = ::xml_schema::namespace_infomap (),
            ::xml_schema::flags f = 0);
...
#endif // CXX_________INPUT_CHECKPOINT_FORMAT_H
